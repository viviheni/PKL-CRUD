                    ...
                    <div class="card-body">
                        <form action="{{ route('jurusan.update', $jurusan->id) }}" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="nama_mata_pelajaran" class="form-control @error('nama_mata_pelajaran') is-invalid @enderror" value={{ $jurusan->nama_jurusan }}>
                                </input>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="semester" class="form-control @error('semester') is-invalid @enderror" value={{ $jurusan->alamat_jurusan }}>
                                </input>
                                @error('semester')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
